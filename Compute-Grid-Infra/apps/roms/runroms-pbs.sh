...
mpirun -np $NP -machinefile $PBS_NODEFILE  -env I_MPI_FABRICS=dapl -env I_MPI_DAPL_PROVIDER=ofa-v2-ib0 -env I_MPI_DYNAMIC_CONNECTION=0 ./oceanM Data/INPUT/ne_atl_HC_3.6.in
